from core.data_provider import kth_action, mnist, bair, benchmark
...
def data_provider(dataset_name, train_data_paths, valid_data_paths, batch_size, img_height, img_width, seq_length, injection_action, is_training=True):
